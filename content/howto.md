...
<li class="list-group-item"> <a href="/how-to/external/Notebook_Package_Iscores.html" target="_blank">Using "Imputation Scores" for assessing missing value imputations (using R package Iscores)</a> by Meta-Lina Spohn and Jeffrey Näf (ETH Zurich)</li>
