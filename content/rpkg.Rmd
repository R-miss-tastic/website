...
pkg_list <- c("mice", "miceDRF", "missForest", "missMDA", "Hmisc", "naniar", 
              "simputation", "VIM", "imputeLCMD", "missCompare", 
              "Amelia", "mixgb", "CALIBERrfimpute", "imputeTS")  
pkg_category <- c("Multiple Imputation",
                  "Multiple Imputation",
                  "Single Imputation",
