...
Inspired by [CRAN Task View on Missing Data](https://cran.r-project.org/web/views/MissingData.html) and a [review](http://journal-sfds.fr/article/view/681) of Imbert & Villa-Vialaneix on handling missing values (2018, written in French) we organized our selection of relevant references on missing values by different topics. 
...
### Deep Learning
The advance and success of _deep networks_ (also known as _neural networks_) in many research and application areas such as computer vision and natural language processing has also re-discovered the problem of handling missing values. Indeed the question of training neural networks on incomplete data has been considered even before the latest rise of deep learning and is considered to be essential due to the impact of missingness on the feasibility and quality of various learning problems. TBC.
