...
Here, note that the generation of missing values relies on the first definition "by pattern" of MAR mechanism, which has been introduced in [@inference_missData]. 
